...
11. [Что представляет собой объект ServletConfig?](#11-----servletconfig)
12. [Что представляет собой объект ServletContext?](#12-----servletcontext)
13. [В чем отличия ServletContext и ServletConfig?](#13----servletcontext--servletconfig)
14. [Что такое Request Dispatcher?](#14---request-dispatcher)
